...
export declare enum DependantStatus {
    ACTIVE = "active",
    INACTIVE = "inactive",
    SUSPENDED = "suspended"
}
export declare enum DependantRelationship {
    SPOUSE = "spouse",
    CHILD = "child",
    PARENT = "parent",
    SIBLING = "sibling",
...
export interface MedicalSchemeCreationAttributes extends Omit<MedicalSchemeAttributes, "id" | "createdAt" | "updatedAt"> {
    id?: string;
}
...
export interface MemberSubscriptionCreationAttributes extends Omit<MemberSubscriptionAttributes, "id" | "createdAt" | "updatedAt"> {
    id?: string;
}
...
export interface PaymentCoverageCreationAttributes extends Omit<PaymentCoverageAttributes, "id" | "createdAt"> {
    id?: string;
}
...
export interface CommissionPaymentCreationAttributes extends Omit<CommissionPaymentAttributes, "id" | "createdAt" | "updatedAt"> {
    id?: string;
}
...
export interface CommissionPaymentDetailCreationAttributes extends Omit<CommissionPaymentDetailAttributes, "id" | "createdAt"> {
    id?: string;
}
...
export interface ShaTransferCreationAttributes extends Omit<ShaTransferAttributes, "id" | "createdAt" | "updatedAt"> {
    id?: string;
}
...
export interface ShaTransferDetailCreationAttributes extends Omit<ShaTransferDetailAttributes, "id" | "createdAt"> {
    id?: string;
}
...
export interface SystemConfigCreationAttributes extends Omit<SystemConfigAttributes, "id" | "createdAt" | "updatedAt"> {
    id?: string;
}
...
export interface AuditLogCreationAttributes extends Omit<AuditLogAttributes, "id" | "timestamp"> {
    id?: string;
}
...
export interface ApiLogCreationAttributes extends Omit<ApiLogAttributes, "id" | "timestamp"> {
    id?: string;
}
...
export interface UssdSessionCreationAttributes extends Omit<UssdSessionAttributes, "id" | "startedAt" | "lastActivity"> {
    id?: string;
}
...
export interface RegistrationData extends Omit<UserCreationAttributes, "passwordHash"> {
    password: string;
...
export interface DocumentCreationAttributes extends Omit<DocumentAttributes, "id" | "createdAt" | "updatedAt" | "uploadedAt"> {
    id?: string;
}
...
export interface DependantCreationAttributes extends Omit<DependantAttributes, "id" | "createdAt" | "updatedAt" | "isVerified" | "status"> {
    id?: string;
    status?: DependantStatus;
}
