...
async function seedUsers(transaction) {
    ...
    try {
        const existingUsers = await models_1.User.count({ transaction: t });
        if (existingUsers > 0) {
        ...
        const superAdmin = await models_1.User.create({
            ...
            role: types_1.UserRole.SUPERADMIN,
            isActive: true,
        ...
        const coordinators = await models_1.User.bulkCreate([
            {
                firstName: "John",
                ...
                county: "Mombasa",
                membershipStatus: types_1.MembershipStatus.ACTIVE,
                role: types_1.UserRole.COORDINATOR,
                isActive: true,
                isEmailVerified: true,
                isPhoneVerified: true,
                isIdNumberVerified: true,
        ...
        const delegates = await models_1.User.bulkCreate([
            {
                firstName: "Peter",
                lastName: "Delegate",
        ...
        const members = await models_1.User.bulkCreate([
            {
                firstName: "Alice",
                lastName: "Member",
        ...
        const pendingMembers = await models_1.User.bulkCreate([
            {
                firstName: "Frank",
                lastName: "Pending",
                ...
                sacco: "Nairobi Sacco",
                route: "Route D",
                membershipStatus: types_1.MembershipStatus.PENDING,
                role: types_1.UserRole.MEMBER,
                isActive: true,
