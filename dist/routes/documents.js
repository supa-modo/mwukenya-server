...
const DocumentController_1 = __importStar(require("../controllers/DocumentController"));
const auth_1 = require("../middleware/auth");
const types_1 = require("../types");
const router = (0, express_1.Router)();
router.use(auth_1.authenticate);
router.post("/upload", DocumentController_1.upload.single("file"), DocumentController_1.default.uploadDocument);
router.get("/", DocumentController_1.default.getUserDocuments);
router.get("/:documentId", DocumentController_1.default.getDocumentById);
router.get("/:documentId/url", DocumentController_1.default.getDocumentUrl);
router.put("/:documentId", DocumentController_1.default.updateDocument);
